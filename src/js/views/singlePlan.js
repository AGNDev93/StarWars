...
// 	useEffect(() => {
// 		if (store.planets){
// 			if(store.planets.length>0 && params.theid){
// 				const result=store.planets.find(item => item.url.split("/")[5] == params.theid)
// 				if(result){
...
// 						<h5 className="card-title text-center">{currentPlanet.name}</h5>
...
// 						<div className="col-md-2 my-3">
// 							<h6>Birth Year</h6>
// 							<p>{currentPlanet.climate}</p>
// 						</div>
// 						<div className="col-md-2 my-3">
// 							<h6>Gender</h6>
// 							<p>{currentPlanet.population}</p>
// 						</div>
// 						<div className="col-md-2 my-3">
// 							<h6>Height</h6>
// 							<p>{currentPlanet.orbital_period}</p>
// 						</div>
// 						<div className="col-md-2 my-3">
// 							<h6>Skin Color</h6>
// 							<p>{currentPlanet.rotation_period}</p>
// 						</div>
// 						<div className="col-md-2 my-3">
// 							<h6>Eye Color</h6>
// 							<p>{currentPlanet.diameter}</p>
// 						</div>
// 					</div>
